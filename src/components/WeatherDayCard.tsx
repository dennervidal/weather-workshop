...
export const WeatherDayCard = memo(
  ({
    index,
    selectedDay,
    dayName,
    ...
    return (
      <div
        className={`${
          isSelected
            ? "bg-[#BBD7EC] w-[25vw] text-white"
            : "bg-[#333333] w-[12vw] text-gray-300"
        } rounded-[30px] h-[270px] cursor-pointer text-center overflow-hidden transition-all duration-300 ease-in-out`}
